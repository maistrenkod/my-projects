...
public interface XPathCaller {
     ...
     */
    Element[] getEmployees (Document src, String deptno, String docType) throws XPathExpressionException, FileNotFoundException;
     ...
     * @param docType "emp" - для файла типа emp.xml; "emp-hier" - для файла типа emp-hier.xml
     */
    String getHighestPayed(Document src, String docType) throws XPathExpressionException, TransformerException;
     ...
     * @param docType "emp" - для файла типа emp.xml; "emp-hier" - для файла типа emp-hier.xml
     */
    String getHighestPayed(Document src, String deptno, String docType) throws TransformerException, XPathExpressionException;
    /**
     * Выбрать всех топовых менеджеров (менеджер топовый, если над ним нет менеджера)
     * @param src XML документ для поиска
     * @param docType "emp" - для файла типа emp.xml; "emp-hier" - для файла типа emp-hier.xml
     */
    Element[] getTopManagement(Document src, String docType) throws XPathExpressionException, TransformerException;
    /**
     ...
     * @param docType "emp" - для файла типа emp.xml; "emp-hier" - для файла типа emp-hier.xml
     */
    Element[] getOrdinaryEmployees(Document src, String docType) throws XPathExpressionException;
     ...
     * @param docType "emp" - для файла типа emp.xml; "emp-hier" - для файла типа emp-hier.xml
     */
    Element[] getCoworkers(Document src, String empno, String docType) throws XPathExpressionException, TransformerException;
}
